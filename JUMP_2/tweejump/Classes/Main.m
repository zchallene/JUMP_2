...
//	[batchNode addChild:cloud z:3 tag:currentCloudTag];
    NSString *imagName = [NSString stringWithFormat:@"cloud%ld.png",random()%7+1];
    ...
    CCSprite *cloud = [CCSprite spriteWithSpriteFrame:frame];
    [self addChild:cloud z:3 tag:currentCloudTag];
